...
Think of them as ***rotations in different numbers of independent directions***. A simple way to see the difference between _U(1), SU(2), and SU(3)_ on [Generating a Standard Model](https://eq19.github.io/multiplication/#standard-model).
...
By _[multiplication zones](https://eq19.github.io/multiplication/)_ we will provide a direct route to unbroken internal symmetries, generated by ***SU(3) x SU(2) x U(1)***, for [one (1) generation of quarks and leptons](https://github.com/eq19/maps/files/14387513/Standard_model_physics_from_an_algebra.pdf).

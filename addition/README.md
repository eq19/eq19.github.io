...
By _[multiplication zones](https://eq19.github.io/multiplication/)_ we will provide a direct route to an unbroken internal symmetries, generated by ***SU(3) and U(1)***, for [one (1) generation of quarks and leptons](https://github.com/eq19/maps/files/14387513/Standard_model_physics_from_an_algebra.pdf).

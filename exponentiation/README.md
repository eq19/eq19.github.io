...
- From just the C ⊗ O portion of the algebra, we find minimal left ideals, and show that ***they mirror the behaviour of a generation of quarks and leptons under su(3)c and u(1)em***.[![multiplication of octonionic imaginary units](https://github.com/user-attachments/assets/e6cee651-8fcf-4396-822d-306752f7a194)](https://theoryofeverything.org/theToE/2016/01/08/introducing-the-sedenion-fano-tesseract-mnemonic/)
